...
source('/Users/davids/Documents/Work/Thesis/Winners Curse/R code/methodsX-winners.r')
...
head(frame)
dim(frame)
write.csv(frame,'/Users/davids/Documents/Work/Thesis/GAW17/newsimSIRT1')
newSIRT1=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/newsimSIRT1')
head(newSIRT1)
...
#	file = paste('/Users/davids/Documents/Work/Thesis/GAW17/GAW17 CD/unr_phen.',c,sep='')
...
# write.csv(SIRT1dat,paste('/Users/davids/Documents/Work/Thesis/GAW17/boot',name,sep=''))
# bootSIRT1=read.csv(paste('/Users/davids/Documents/Work/Thesis/GAW17/boot',name,sep=''))

# write.csv(SIRT1dat,paste('/Users/davids/Documents/Work/Thesis/GAW17/boot1',name,sep=''))
# boot1SIRT1=read.csv(paste('/Users/davids/Documents/Work/Thesis/GAW17/boot1',name,sep=''))

# write.csv(SIRT1dat,paste('/Users/davids/Documents/Work/Thesis/GAW17/boot2',name,sep=''))
# boot2SIRT1=read.csv(paste('/Users/davids/Documents/Work/Thesis/GAW17/boot2',name,sep=''))
...
source("/Users/davids/Documents/Work/Thesis/Winners Curse/R code/GW-functions.R")# YOU READ IN THE FUNCTIONS FOR OUR METHOD
...
mean(SIRT1dat$B3);mean(SIRT1dat$B4);mean(SIRT1dat$B10);mean(SIRT1dat$B11);
##Bias-Winner's Curse
mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B3)
mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B4)
mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B10)
mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B11)
##Absolute Bias
(mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B3)-vec[3])
(mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B4)-vec[4])
(mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B10)-vec[10])
(mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B11)-vec[11])
##Relative Bias
(mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B3)-vec[3])/vec[3]
(mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B4)-vec[4])/vec[4]
(mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B10)-vec[10])/vec[10]
(mean(SIRT1dat[SIRT1dat$pQH<0.05,]$B11)-vec[11])/vec[11]
...
write.csv(SIRT1dat,paste('/Users/davids/Documents/Work/Thesis/GAW17/bootQ',name,sep=''))
bootSIRT1Q=read.csv(paste('/Users/davids/Documents/Work/Thesis/GAW17/bootQ',name,sep=''))

write.csv(SIRT1dat,paste('/Users/davids/Documents/Work/Thesis/GAW17/boot1Q',name,sep=''))
boot1SIRT1Q=read.csv(paste('/Users/davids/Documents/Work/Thesis/GAW17/boot1Q',name,sep=''))
head(boot1SIRT1Q,100)

write.csv(SIRT1dat,paste('/Users/davids/Documents/Work/Thesis/GAW17/boot2Q',name,sep=''))
boot2SIRT1Q=read.csv(paste('/Users/davids/Documents/Work/Thesis/GAW17/boot2Q',name,sep=''))
...
write.csv(frame,paste('/Users/davids/Documents/Work/Thesis/GAW17/',name,sep=''))
...
fdat=read.csv(paste('/Users/davids/Documents/Work/Thesis/GAW17/',name,sep=''))
fdat
###### BCHE
...
write.csv(fdat,paste('/Users/davids/Documents/Work/Thesis/GAW17/boot',name,sep=''))
...
bootBCHE=read.csv(paste('/Users/davids/Documents/Work/Thesis/GAW17/boot',name,sep=''))
head(bootBCHE)
plot(bootBCHE)
...
bootSIRT1=read.csv(paste('/Users/davids/Documents/Work/Thesis/GAW17/bootSIRT1',sep=''))
bootBCHE=read.csv(paste('/Users/davids/Documents/Work/Thesis/GAW17/bootBCHE',sep=''))


SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootSIRT1')
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootBCHE')
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootPDGFD')
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootSREBF1')
#SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootGCKR')
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootRARB')
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootPLAT')
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootVLDLR')
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootVNN3')
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootINSIG1')
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootLPL')
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/bootVWF')
...
VNN1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/VNN1')
head(VNN1dat)
...
BCHEdat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/BCHE')
...
SIRT1dat=read.csv('/Users/davids/Documents/Work/Thesis/GAW17/SIRT1')
head(SIRT1dat)
